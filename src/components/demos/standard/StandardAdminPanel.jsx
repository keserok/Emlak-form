  ...
  return (
    <div className="bg-[#F8F9FA] text-slate-800 min-h-screen">
      ...
      <div className="bg-white border-b border-slate-200 px-4 sm:px-8">
        <div className="max-w-6xl mx-auto flex items-center gap-6 overflow-x-auto text-xs font-semibold">
          ...
          >
            ...
            <span>Gelen Talepler & Formlar</span>
            <span className="px-2 py-0.5 rounded-full text-[10px] bg-slate-100 font-mono">
              {submissions.length}
            </span>
          </button>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-8 py-8">
          ...
          <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              <div>
                ...
                <p className="text-xs text-slate-500">Mülk değerleme formu ve iletişim kanallarından gelen tüm kayıtlar.</p>
              </div>
            ...
            {filteredSubmissions.length === 0 ? (
              ...
              <div className="grid grid-cols-1 gap-4">
                {filteredSubmissions.map((sub) => (
                  <div 
                    key={sub.id} 
                    className="bg-white p-5 sm:p-6 rounded-2xl border border-slate-200 shadow-xs flex flex-col md:flex-row md:items-center justify-between gap-4"
                  >
                    <div className="space-y-2 max-w-2xl">
                      <div className="flex flex-wrap items-center gap-2">
                        <span className="font-mono text-xs font-bold text-[#2C3E35] bg-[#FAF8F5] px-2 py-0.5 rounded-md border border-[#E8E4DC]">
                          {sub.refCode}
                        </span>
                        <span className="font-semibold text-sm text-slate-900">{sub.fullName}</span>
                      ...
                      <div className="flex flex-wrap items-center gap-3 text-xs text-slate-600">
                        <span className="flex items-center gap-1">
                          <Building2 className="w-3.5 h-3.5 text-[#7C6A59]" />
                    ...
                    <div className="flex sm:flex-col items-center sm:items-end justify-between gap-3 shrink-0 pt-3 sm:pt-0 border-t sm:border-t-0 border-slate-100">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <a
                          href={`https://wa.me/${sub.phone.replace(/[^0-9]/g, '')}?text=${encodeURIComponent(`Merhaba ${sub.fullName}, mülk talebinizle ilgili Deniz Arslan olarak yazıyorum.`)}`}
                          target="_blank"
                          rel="noreferrer"
        ...
        {/* TAB 2: LISTINGS MANAGEMENT (15 PORTFOLIO LIMIT) */}
        {activeTab === 'listings' && (
          <div className="space-y-6">
            ...
            <div className="bg-white p-5 sm:p-6 rounded-2xl border border-slate-200 shadow-xs flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              <div className="space-y-1">
                <div className="flex items-center gap-2">
                  <h2 className="font-semibold text-base text-slate-900">Butik Portföy Kontenjanı</h2>
                  <span className="text-xs px-2.5 py-0.5 rounded-full bg-emerald-100 text-emerald-800 font-mono font-bold">
                    {listings.length} / 15 Dolu
                  </span>
                </div>
                <p className="text-xs text-slate-500">
                  Standart pakette kalite ve yüksek ilgi için maksimum 15 mülk yayında tutulur.
                </p>
                {/* Progress bar */}
                <div className="w-full sm:w-64 h-2 bg-slate-100 rounded-full overflow-hidden mt-2">
                  <div 
              ...
              <button
                ...
                className="px-5 py-2.5 rounded-xl bg-[#2C3E35] hover:bg-[#1E2522] text-white text-xs font-semibold flex items-center gap-2 transition-colors shadow-sm cursor-pointer shrink-0"
              >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3.5 py-2 rounded-xl border border-slate-200 text-xs focus:outline-none focus:border-[#2C3E35]"
                />
              </div>
          ...
          <div className="bg-white rounded-3xl max-w-lg w-full p-6 sm:p-8 space-y-5 border border-slate-200 shadow-2xl relative">
            ...
            <form onSubmit={handleAddListingSubmit} className="space-y-4">
              ...
              <div className="pt-3 flex items-center justify-end gap-2">
                ...
                <button
                  type="submit"
                  className="px-5 py-2 rounded-xl bg-[#2C3E35] hover:bg-[#1E2522] text-white text-xs font-semibold shadow-sm"
                >
                  Portföyü Ekle
                </button>
              </div>
